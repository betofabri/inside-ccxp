...
export type ConfigWhereInput = {
  ...
  chave?: Prisma.StringFilter<"Config"> | string
  valor?: Prisma.StringFilter<"Config"> | string
}
...
export type ConfigScalarWhereWithAggregatesInput = {
  ...
  chave?: Prisma.StringWithAggregatesFilter<"Config"> | string
  valor?: Prisma.StringWithAggregatesFilter<"Config"> | string
}
...
export type ConfigOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"chave" | "valor", ExtArgs["result"]["config"]>
...
export interface ConfigDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
   ...
   * const configWithChaveOnly = await prisma.config.findMany({ select: { chave: true } })
   * 
   */
   ...
   * })
   * 
   * // Create many Configs and only return the `chave`
   * const configWithChaveOnly = await prisma.config.createManyAndReturn({
   *   select: { chave: true },
   *   data: [
   *     // ... provide data here
   *   ]
   ...
   * })
   * 
   * // Update zero or more Configs and only return the `chave`
   * const configWithChaveOnly = await prisma.config.updateManyAndReturn({
   *   select: { chave: true },
   *   where: {
   *     // ... provide filter here
   *   },
...
export interface ConfigFieldRefs {
  readonly chave: Prisma.FieldRef<"Config", 'String'>
  readonly valor: Prisma.FieldRef<"Config", 'String'>
}
